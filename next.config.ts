    ...
    return [
      {
        ...
        headers: [
          ...
          // Content-Security-Policy - Prevent XSS, clickjacking, etc.
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; img-src 'self' blob: data: https:; font-src 'self' data: https:; media-src 'self' blob: https://devmedia.sealed.love https://media.sealed.love; connect-src 'self' https:; frame-src 'self' https:; object-src 'none';",
          },
