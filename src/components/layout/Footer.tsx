        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col md:items-end">
            <div className="flex flex-wrap gap-x-4 gap-y-2 mb-4 md:justify-end">
              <Link href="/about" className="text-sm hover:text-primary transition-colors" aria-label={t('about')}>
                {t('about')}
              </Link>
              <Link href="/privacy" className="text-sm hover:text-primary transition-colors" aria-label={t('privacy')}>
                {t('privacy')}
              </Link>
              <Link href="/terms" className="text-sm hover:text-primary transition-colors" aria-label={t('terms')}>
                {t('terms')}
              </Link>
              <Link href="/contact" className="text-sm hover:text-primary transition-colors" aria-label={t('contact')}>
                {t('contact')}
              </Link>
            </div>
            <p className="text-xs">
