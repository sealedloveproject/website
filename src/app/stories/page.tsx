    ...
    <div className="fade-in pt-24 pb-20 px-6 max-w-5xl mx-auto text-foreground">
      ...
      <header className="mb-16">
        <div className="mt-10 mb-6 relative text-center">
          ...
          <h1 className="text-3xl md:text-3xl font-bold relative inline-block">Public Stories</h1>
          ...
          <p className="mt-6 text-lg text-foreground/80 text-center max-w-3xl mx-auto">
            Explore love stories, memories, and wisdom that others have chosen to share with the world
          </p>
        </div>
      </header>
