    ...
    <div className="fade-in pt-24 pb-20 px-6 max-w-5xl mx-auto text-foreground">
      ...
      <header className="mb-16">
        <div className="mt-16 mb-6 relative text-center">
          ...
          <h1 className="text-3xl md:text-3xl font-bold relative inline-block">Support Our Mission</h1>
          ...
          <p className="mt-6 text-lg text-foreground/80 text-center max-w-3xl mx-auto">
            Your donation helps us preserve precious memories for generations to come
          </p>
          <p className="mt-4 text-md text-foreground/60 text-center max-w-3xl mx-auto">
            Funds are used to pay for servers, services, and materials needed for our preservation boxes: 
            M-Discs, M-Disc writers, inert gas, protective containers, and other essential components.
            We're committed to this project for at least 20 years, with plans to pass it on to others who share our vision afterward.
            Donors receive no material advantages, products, or special features compared to non-donors, just our heartfelt gratitude 
            and the knowledge that they've helped make this preservation project possible for everyone.
          </p>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card rounded-2xl p-8 shadow-sm border border-border mb-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="md:w-2/3">
              <h2 className="text-2xl font-bold mb-3">Support us on Patreon</h2>
              <p className="text-foreground/80 mb-4">
                Become a monthly supporter on Patreon and help us sustain our mission long-term.
                Your generosity enables us to continue our mission of preserving precious memories for future generations,
                and we're deeply grateful for your belief in our project.
              </p>
            </div>
        ...
        <div className="bg-card rounded-2xl p-8 shadow-sm border border-border mb-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="md:w-2/3">
              <h2 className="text-2xl font-bold mb-3">Make a Donation via PayPal</h2>
              <p className="text-foreground/80 mb-4">
                Donate using PayPal, credit/debit card, or bank transfer. You can choose a one-time donation or set up recurring payments during checkout.
              </p>
              <p className="text-xs text-muted-foreground">
                You will be redirected to PayPal to complete your donation securely. No PayPal account required.
              </p>
            </div>
            <div className="md:w-1/3">
            ...
            <div className="bg-card rounded-2xl p-8 shadow-sm border border-border mb-8">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span>Support our mission to preserve memories for future generations</span>
                </li>
                <li className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-primary">
                  ...
                  <span>Fund essential preservation materials and equipment: M-Discs, archival-grade protective containers, inert gas systems, specialized disc writers, humidity controllers, temperature regulators, anti-static equipment, UV protection materials, and secure vault construction materials</span>
                </li>
                <li className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-primary">
                  ...
                  <span>Help us develop new features and improve our technology</span>
                </li>
                <li className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-primary">
                  ...
                  <span>Enable us to provide our services to more people worldwide</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-sm border border-border">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span>Share our platform with friends and family</span>
                </li>
                <li className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-secondary/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-secondary">
                  ...
                  <span>Volunteer your skills (contact us for opportunities)</span>
                </li>
                <li className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-secondary/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-secondary">
                  ...
                  <span>Create and share your own stories on our platform</span>
                </li>
              </ul>
            </div>
          </div>
