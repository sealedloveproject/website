            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-4">
                <p>{t.rich('sections.faq.questions.cost.answer', {
                  supportLink: (chunks) => <Link href="/support" className="text-primary hover:underline" aria-label={t('sections.faq.questions.cost.answer.supportLink')}>{chunks}</Link>
                })}</p>
              </div>
            </div>
        ...
        <div className="py-12 text-center slide-up">
          <div className="flex flex-col md:flex-row gap-4 justify-center mb-8">
            <Link 
              href="/user/stories" 
              className="btn-primary inline-flex items-center gap-2 group"
              aria-label={t('sections.cta.storeStory')}
            >
            ...
            <Link 
              ...
              aria-label={t('sections.cta.readStories')}
            >
